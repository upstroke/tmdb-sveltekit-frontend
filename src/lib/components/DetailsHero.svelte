...
<section aria-labelledby="details-hero-title" class="details-hero"
		 style={`--details-hero-backdrop: url('${fallbackImage}')`}>
    <div class="details-hero-overlay">
        <div class="details-hero-content">
            <div aria-hidden="true" class="details-hero-poster">
                <img alt="" src={resolvedPosterUrl}/>
            </div>

            <h1 class="details-hero-title" id="details-hero-title">{resolvedTitle}</h1>

            <section aria-labelledby="details-hero-companies-heading" class="details-hero-companies">
                <h2 class="u-sr-only" id="details-hero-companies-heading">Produktionsfirmen</h2>
                <ul>
...
<style lang="scss">
  ...
  .details-hero {
    ...
    background-image: linear-gradient(to top, rgba(0, 0, 0, 0.92) 0%, rgba(0, 0, 0, 0.7) 32%, rgba(0, 0, 0, 0.45) 58%, rgba(0, 0, 0, 0.5) 100%),
