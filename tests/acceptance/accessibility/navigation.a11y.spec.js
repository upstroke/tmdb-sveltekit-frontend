...
test.describe('Accessibility - Desktop Homepage', () => {
	...
	// -------------------------------------------------------------------------
	test(
		'Desktop homepage initial load has no automatically detected WCAG A/AA violations',
		{
			tag: ['@accessibility', '@a11y', '@desktop', '@homepage']
		},
		async ({ page }) => {
	...
	// -------------------------------------------------------------------------
	test(
		'Desktop homepage after load more has no automatically detected WCAG A/AA violations',
		{
			tag: ['@accessibility', '@a11y', '@desktop', '@homepage', '@loadmore']
		},
		async ({ page }) => {
			await page.goto('/?locale=en-US');
			await page.waitForLoadState('networkidle');
			...
			const loadMoreButton = page
				.locator('button:has-text("More results"), button:has-text("Load more"), .load-more button')
				.first();
...
test.describe('Accessibility - Mobile iOS Navigation', () => {
	...
	// -------------------------------------------------------------------------
	test(
		'Mobile iOS homepage with closed burger menu has no automatically detected WCAG A/AA violations',
		{
			tag: ['@accessibility', '@a11y', '@mobile', '@ios', '@burger-menu']
		},
		async ({ page }) => {
			await page.goto('/?locale=en-US');
			await page.waitForLoadState('networkidle');
	...
	// -------------------------------------------------------------------------
	test(
		'Mobile iOS homepage with open burger menu has no automatically detected WCAG A/AA violations',
		{
			tag: ['@accessibility', '@a11y', '@mobile', '@ios', '@burger-menu']
		},
		async ({ page }) => {
	...
	// -------------------------------------------------------------------------
	test(
		'Mobile iOS navigation to movies page has no automatically detected WCAG A/AA violations',
		{
			tag: ['@accessibility', '@a11y', '@mobile', '@ios', '@navigation']
		},
		async ({ page }) => {
			await page.goto('/?locale=en-US');
			await page.waitForLoadState('networkidle');
...
test.describe('Accessibility - Mobile Android Navigation', () => {
	...
	// -------------------------------------------------------------------------
	test(
		'Mobile Android homepage with closed burger menu has no automatically detected WCAG A/AA violations',
		{
			tag: ['@accessibility', '@a11y', '@mobile', '@android', '@burger-menu']
		},
		async ({ page }) => {
			await page.goto('/?locale=en-US');
			await page.waitForLoadState('networkidle');
	...
	// -------------------------------------------------------------------------
	test(
		'Mobile Android homepage with open burger menu has no automatically detected WCAG A/AA violations',
		{
			tag: ['@accessibility', '@a11y', '@mobile', '@android', '@burger-menu']
		},
		async ({ page }) => {
	...
	// -------------------------------------------------------------------------
	test(
		'Mobile Android navigation to movies page has no automatically detected WCAG A/AA violations',
		{
			tag: ['@accessibility', '@a11y', '@mobile', '@android', '@navigation']
		},
		async ({ page }) => {
			await page.goto('/?locale=en-US');
			await page.waitForLoadState('networkidle');
