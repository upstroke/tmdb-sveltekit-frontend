...
- **Test Plan:** `../loadmore/loadmore-testplan.md`
- **Test Files:**
  - `../loadmore/loadmore-home.spec.js`
  - `../loadmore/loadmore-movies.spec.js`
  - `../loadmore/loadmore-tvshows.spec.js`
...
**Report stored at:**
```
tests/acceptance/bug-example/BUG-001-resolution-report.md
```
